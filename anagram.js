...
function displayWord(word, difficulty) {
    ...
    var letterSquaresContainer = document.getElementById('letterSquares');
    var letterSquaresContainer2 = document.getElementById('letterSquares2');

    // Clear the container before adding new divs
    letterSquaresContainer.innerHTML = '';

    // Clear the container before adding new divs
    letterSquaresContainer2.innerHTML = '';

    // Create divs for each letter in the scrambled word
    for (let i = 0; i < scrambledWord.length; i++) {
        letterSquaresContainer.innerHTML += `<div class="letterSquare">${scrambledWord[i]}</div>`;
    }

    // Create empty divs for the remaining letters
    for (let i = 0; i < scrambledWord.length; i++) {
        letterSquaresContainer2.innerHTML += `<div class="letterSquare" id="letter${count}"></div>`;

        let elementID = "letter" + count;
...
function addLetter(element) {
    ...
    let currentBoxCount = boxCount + 1

    console.log(currentBoxCount)
    console.log(currentWord.length)

    if(currentBoxCount > currentWord.length){
        return;
    }
...
function removeLetter(){
    ...
    var elementID = "letter" + currentBoxCount;
    var box = document.getElementById(elementID);
...
function getGuess(){
    ...
    for (let i = 0; i < boxes.length; i++) {
        ...
        currentGuess += currentBox.innerHTML;     
...
function submitGuess() {
    ...
    let testGuess = getGuess();

    gL = testGuess.length;
    wL = correctWord.length;

    if(testGuess.length < currentWord.length){
        return;
    }
    ...
    if (testGuess === correctWord) {
        ...
        for (i = 0; i < boxes.length; i ++){
            ...
            let id = "letter" + i
            let greenBox = document.getElementById(id)

            greenBox.classList.add('right');
        }
    ...
    setTimeout(() => {
        ...
        for (i = 0; i < boxes.length; i ++){
            ...
            greenBox.classList.remove('right');
        }
        showNextWord();
      }, "300");
